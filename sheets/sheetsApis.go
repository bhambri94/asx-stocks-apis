...
func BatchGet(SheetRange string) [][]string {
	...
	// lengthOfRows := len(batchGetResponse.ValueRanges[0].Values)
	// var symbols []string
	// i := 0
	// for i < lengthOfRows {
	// 	symbols = append(symbols, batchGetResponse.ValueRanges[0].Values[i][0])
	// 	i++
	// }
	// fmt.Println(i)
	// fmt.Println("sysmobols length")
...
func BatchAppend(SheetName string, value [][]interface{}) {
	...
	// range2 = range // TODO: Update placeholder value.

	// How the input data should be interpreted.
	valueInputOption := "RAW" // TODO: Update placeholder value.

	// How the input data should be inserted.
	insertDataOption := "INSERT_COLUMNS" // TODO: Update placeholder value.
